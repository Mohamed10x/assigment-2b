...
// Sept-27-2018
//  This code calculates how high a person will be after a certain amount of seconds
...
class ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instructionLabel.text = "Calculate the height of a person "
        ...
        secondsTextField.placeholder = "In s"
    ...
    @objc func calculateAreaAndPerimeter() {
        // calculate the height of a person
